/* Tweaks panel — ported from tweaks-panel.jsx (window globals → module exports) */
...
type RadioOption = string | number | { value: string | number; label: string };

export function TweakRadio({ label, value, options, onChange }: { label: string; value: string | number; options: RadioOption[]; onChange: (v: string | number) => void }) {
...
export function TweakSelect({ label, value, options, onChange }: { label: string; value: string | number; options: RadioOption[]; onChange: (v: string) => void }) {
  return (
    <TweakRow label={label}>
